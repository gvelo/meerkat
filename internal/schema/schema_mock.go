...
// Source: /Users/sdominguez/desa/workspace_go/eventdb/internal/schema/schema.go
...
// FieldByName mocks base method
func (m *MockSchema) FieldByName(name string) (Field, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FieldByName", name)
	ret0, _ := ret[0].(Field)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FieldByName indicates an expected call of FieldByName
func (mr *MockSchemaMockRecorder) FieldByName(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FieldByName", reflect.TypeOf((*MockSchema)(nil).FieldByName), name)
}
