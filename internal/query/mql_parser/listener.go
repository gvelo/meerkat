...
func (l *MQLListener) EnterBinCommand(c *BinCommandContext) {
...
func (l *MQLListener) ExitBinCommand(c *BinCommandContext) {
...
func (l *MQLListener) GetTree() *logical.Projection {
